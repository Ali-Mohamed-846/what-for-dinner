...
function getRandomIndex() {
    ...
    while (newmeal === lastmeal){
        newmeal = Math.floor(Math.random() * recipe.length);
    ...
    var meal = recipe[randomnum]



    
    var randomnum = Math.floor(Math.random() * recipe.length)
    var meal = recipe[randomnum]
    ...
    for (i = 0; i < meal.ingredients.length; i++) {
     ...
     <li class="d-flex align-items-start">
                                        <div
                                            class=" rounded-circle d-flex align-items-center justify-content-center text-white  fw-bolder fs-12 flex-shrink-0 ">
                                            ${i + 1}</div>
                                        <span class="text-gray-700">${meal.ingredients[i]}</span>
                                    </li>
...
`;
    ...
    var cartoona1 = `<li class="d-flex align-items-start ">
                                        <div
                                            class="d-flex justify-content-center align-items-center  rounded-4 text-white fw-bold ">
                                            1</div>
                                        <span class="mt-2 instructions-label">${meal.instructions[0]}</span>
                                    </li>
   `
    for (i = 1; i < meal.instructions.length; i++) {
    ...
    <li class="d-flex align-items-start  mt-4">
                                        <div
                                            class="d-flex justify-content-center align-items-center  rounded-4 text-white fw-bold  ">
                                            ${i+1}</div>
                                        <span class="mt-2 instructions-label">${meal.instructions[i]}</span>
                                    </li>
...
`;
    ...
    var cartoona2 = ` <div class="col-12 p-3 d-flex align-items-center ">
                                    <i class="fa-solid fa-circle-check me-2" style="color: #e17100;"></i>
                                    <span class="tips">${meal.tips[0]}</span>
                                </div>
`
    for (i = 1; i < meal.tips.length; i++) {

        cartoona2 += `
 <div class="col-12 p-3 d-flex align-items-center gy-3">
                                    <i class="fa-solid fa-circle-check me-2" style="color: #e17100;"></i>
                                    <span class="tips">${meal.tips[i]}</span>
                                </div>
...
`;
    ...
    document.getElementById("meal-section").innerHTML = `   <div class="Meal-img col-12  col-lg-5 p-0 position-relative " >
                    <img src="${meal.imgCover}" class="w-100 object-fit-cover  rounded-start-4 rounded-bottom-0 meal-image"
                        alt="">
                   <span class="px-3 py-2 bg-white rounded-pill d-flex align-items-center review"> <i class="fa-solid fa-star me-2" style="color: #FDC700;"></i> <span class="me-2">${meal.ratingsAverage}</span> <span class="fs-14 me-1">(review ${meal.ratingsQuantity})</span></span>
                    <div class="row p-4 column-gap-0 bg-white time rounded-4 ">
<div class="d-flex flex-column col-4 text-center ">
    <i class="fa-solid fa-clock fa-xl mt-1 mb-3 mx-auto" style="color: #FF6900;"></i>
    <span class="fs-14 ">Prep Time</span>
    <span class="fw-bold">${meal.prepTime}</span>
</div>
<div class="d-flex flex-column col-4 text-center">
    <i class="fa-solid fa-fire-burner fa-xl mx-auto  mt-1 mb-3" style="color: #FB2C36;"></i>
    <span class="fs-14">Cook Time</span>
    <span class="fw-bold">${meal.cookTime}</span>
</div>
<div class="d-flex flex-column col-4 text-center">
    <i class="fa-solid fa-users fa-xl mt-1 mb-3 mx-auto" style="color: #2B7FFF;"></i>
    <span class="fs-14">Servings</span>
    <span class="fw-bold">${meal.servings}</span>
</div>
                ...
                <div class=" col-12 col-lg-7 p-40 meal-ingredient  h-100">
                    <div class="meal-title d-flex justify-content-between mb-2 ">
                        <div>
                            <span class="difficulty rounded-4">${meal.difficulty}</span>
                            <span class="category rounded-4">${meal.category}</span>
                            <h1 class="fw-bolder my-2 meal-name">${meal.name}</h1>
                            <p class="fs-18 description m-0">${meal.description}</p>
                        </div>
                        <div class="save-share-meal d-flex ">
                            <div class="d-flex justify-content-center align-items-center me-2 rounded-4">
                                <i class="fa-solid fa-bookmark" style="color: #f54a00;"></i>
                            </div>
                            <div class="d-flex justify-content-center align-items-center rounded-4">
                                <i class="fa-solid fa-share-nodes" style="color: #f54a00;"></i>
                            </div>
                        </div>

                    </div>
                     <div class="alert p-3 mb-2 mt-4 rounded-3 d-flex align-items-center " id="alert">
                        <div>
                            <i class="fa-solid fa-triangle-exclamation fa-lg me-3" style="color: #FB2C36;"></i>
                        </div>
                        <div>
                            <span class="fw-bolder">Extended Preparation Time</span>
                            <p class="fs-14 m-0">This recipe requires more than 45 minutes to prepare. Plan accordingly!
                            </p>
                        </div>
                    </div>
                    <div>
                    <ul class="nav nav-tabs mb-4 py-3" id="myTab" role="tablist">
                        <li class="nav-item pe-5 pe-md-3" role="presentation">
                            <button class="nav-link active fw-600  " id="ingredients-tab" data-bs-toggle="tab"
                                data-bs-target="#ingredients-pane" type="button" role="tab" aria-controls="ingredient-pane"
                                aria-selected="true"><i class="fa-solid fa-list-check me-1"></i> Ingredients</button>
                        </li>
                        <li class="nav-item pe-md-3" role="presentation">
                            <button class="nav-link fw-600" id="instructions-tab" data-bs-toggle="tab"
                                data-bs-target="#instructions-tab-pane" type="button" role="tab"
                                aria-controls="instructions-tab-pane" aria-selected="false"><i
                                    class="fa-etch fa-solid fa-book-open me-1"></i> Instructions</button>
                        </li>
                        <li class="nav-item pe-5 pe-md-3" role="presentation">
                            <button class="nav-link fw-600" id="Nutrition-tab" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-600" id="chef-tab" data-bs-toggle="tab"
                                data-bs-target="#chef-tab-pane" type="button" role="tab" aria-controls="chef-tab-pane"
                                aria-selected="false"><i class="fa-solid fa-lightbulb me-1"></i> Chef's Tips</button>
                        </li>

                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active h-350 overflow-y-auto" id="ingredients-pane" role="tabpanel"
                            aria-labelledby="ingredients-tab" tabindex="0">
                            <div class=" rounded-4 ingredients p-4 mb-3 ">
                        ...
                        <div class="tab-pane fade h-350 overflow-y-auto" id="instructions-tab-pane" role="tabpanel"
                        ...
                        <div class="tab-pane fade h-350  overflow-y-auto overflow-x-hidden " id="Nutrition-tab-pane" role="tabpanel"
                            aria-labelledby="Nutrition-tab" tabindex="0">
                            <div class="Nutrition row  px-3 g-3 ">
                                <div
                                    class="col-lg-6 col-12 card-of-meal p-3 d-flex justify-content-between align-items-center rounded-4">
                                    <div class="d-flex align-items-center ">
                                        <div
                                            class="d-flex justify-content-center align-items-center rounded-3 calories-icon me-2 ">
                                            <i class="fa-solid fa-fire" style="color: #f54a00;"></i>
                                        </div>
                                        <span class="fw-medium Nutrition-name">Calories</span>
                                    </div>
                                    <span class="fw-bolder fs-20 Nutrition-value">480 kcal</span>
                                </div>
                                <div
                                    class="col-lg-6 col-12 card-of-meal p-3 d-flex justify-content-between align-items-center rounded-4">
                                    <div class="d-flex align-items-center ">
                                        <div
                                            class="d-flex justify-content-center align-items-center rounded-3 protein-icon me-2 ">
                                            <i class="fa-solid fa-dumbbell" style="color: #155dfc;"></i>
                                        </div>
                                        <span class="fw-medium Nutrition-name">Protein</span>
                                    </div>
                                    <span class="fw-bolder fs-20 Nutrition-value">22g</span>
                                </div>
                                <div
                                    class="col-lg-6 col-12card-of-meal p-3 d-flex justify-content-between align-items-center rounded-4">
                                    <div class="d-flex align-items-center ">
                                        <div
                                            class="d-flex justify-content-center align-items-center rounded-3 Carbohydrates-icon me-2 ">
                                            <i class="fa-solid fa-wheat-awn" style="color: #cd8700;"></i>
                                        </div>
                                        <span class="fw-medium Nutrition-name">Carbohydrates</span>
                                    </div>
                                    <span class="fw-bolder fs-20 Nutrition-value ">48g</span>
                                </div>
                                <div
                                    class="col-lg-6 col-12 card-of-meal p-3 d-flex justify-content-between align-items-center rounded-4">
                                    <div class="d-flex align-items-center ">
                                        <div
                                            class="d-flex justify-content-center align-items-center rounded-3 Fat-icon me-2 ">
                                            <i class="fa-solid fa-droplet" style="color: #e7000b;"></i>
                                        </div>
                                        <span class="fw-medium Nutrition-name">Fat</span>
                                    </div>
                                    <span class="fw-bolder fs-20 Nutrition-value">22g</span>
                                </div>
                                <div
                                    ...
                                    <div class="d-flex align-items-center ">
                                        <div
                                            class="d-flex justify-content-center align-items-center rounded-3 Fiber-icon me-2 ">
                                            <i class="fa-solid fa-seedling" style="color: #00a63e;"></i>
                                        </div>
                                        <span class="fw-medium Nutrition-name">Fiber</span>
                                    </div>
                                    <span class="fw-bolder fs-20 Nutrition-value">3g</span>
                                </div>
                                <div
                                    class="col-lg-6 col-12 card-of-meal p-3 d-flex justify-content-between align-items-center rounded-4">
                                    <div class="d-flex align-items-center ">
                                        <div
                                            class="d-flex justify-content-center align-items-center rounded-3 Sodium-icon me-2 ">
                                            <i class="fa-solid fa-cube" style="color: #e60076;"></i>
                                        </div>
                                        <span class="fw-medium Nutrition-name">Sodium</span>
                                    </div>
                                    <span class="fw-bolder fs-20 Nutrition-value">680mg</span>
                                </div>
                        ...
                        <div class="tab-pane fade " id="chef-tab-pane" role="tabpanel" aria-labelledby="chef-tab"
                            tabindex="0">
                            <div class="row chef-tips ms-2 h-350 ">
                               ${cartoona2}
                            </div>
                        </div>
                    </div>
</div>
                    <div class="other-recipe   mt-4">
                        <button onclick="reloadmeal()" class="mt-4 button fw-600 border-0  text-white"><i class="fa-solid fa-rotate me-2"
                                style="color: #ffffff;"></i>Try Another Recipe</button>
